		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#brcomgestaofioriappreport376-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomgestaofioriappreport376-display": {
								"semanticObject": "brcomgestaofioriappreport376",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.gestao.fioriappreport376",
									"url": sap.ui.require.toUrl("br/com/gestao/fioriappreport376")
								}
							}
						}
					}
